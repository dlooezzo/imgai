...
class BrandingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $settings = [
            ...
            'seo_default_description' => SiteSetting::get('seo_default_description', 'Synthesize photorealistic 2MP cinematic imagery and fluid motion video sequences with Wan 2.2 and Seedance 1.5 Pro generative AI models.'),
            'seo_homepage_description' => SiteSetting::get('seo_homepage_description', 'Transform creative ideas into photorealistic 2MP visual assets and cinematic motion videos with Wan 2.2 and Seedance 1.5 Pro AI models.'),
            'seo_meta_keywords' => SiteSetting::get('seo_meta_keywords', 'AI image generator, text to image, AI video studio, photorealistic AI, Wan 2.2, Seedance'),
