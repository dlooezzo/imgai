...
{
    protected SeedanceImageToVideoService $aiService;
    ...
    public function __construct(SeedanceImageToVideoService $aiService, R2StorageService $r2Service, CreditService $creditService, AiCreditPricingService $pricingService)
    {
...
public function generate(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'duration'          => 'nullable|integer|min:2|max:12',
        ...
        try {
            ...
            $this->r2Service->assertPublicUrl($r2ImageUrl);
            ...
            $seed         = isset($validated['seed']) && is_numeric($validated['seed']) ? (int) $validated['seed'] : -1;
            ...
            $generation = VideoGeneration::create([
                ...
                'ratio'             => $ratio,
                'aspect_ratio'      => $ratio, // Keep backward compatibility
            ...
            $generation->update([
                ...
                'model_version'  => $prediction['version'] ?? 'seedance-1.0-pro-fast',
                'status'         => $prediction['status'] ?? 'submitted',
                'job_dispatched' => true,
            ]);
